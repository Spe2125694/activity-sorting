...
public class SortingUtility {
    ...
    public static <T extends Comparable<T>> void selectionSort(T @NotNull [] data) {
    ...
    public static <T extends Comparable<T>> void insertionSort(T @NotNull [] data) {
    ...
    public static <T extends Comparable<T>> void bubbleSort(T @NotNull [] data) {
    ...
    private static <T extends Comparable<T>> int partition(T @NotNull [] data, int min, int max) {
    ...
    private static <T extends Comparable<T>> void merge(T @NotNull [] data, int first, int mid, int last) {
